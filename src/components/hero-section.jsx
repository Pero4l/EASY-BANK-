    ...
    return(
        ...
        <div className="flex flex-col-reverse lg:flex-row lg:items-center justify-between lg:p-32">
            ...
            <div >
                ...
                <p className=" px-2 py-4 translate-x-3 text-[19px] lg:py-5   text-gray-500 lg:text-xl lg:w-[500px] lg:translate-x-0 leading-8 lg:leading-snug "> Take your financial life online. Your Easybank account will be a one-stop-shop 
